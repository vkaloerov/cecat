...
typedef struct OSAL_PACKED
{
    struct  OSAL_PACKED {
        ...
        uint8_t _1_display1; /* addr 0x0000, slave DC_Device */
        uint8_t _2_display1; /* addr 0x0001, slave DC_Device */
        uint8_t _3_display1; /* addr 0x0002, slave DC_Device */
        uint8_t _4_display1; /* addr 0x0003, slave DC_Device */
        uint8_t _5_display1; /* addr 0x0004, slave DC_Device */
        uint8_t _6_display1; /* addr 0x0005, slave DC_Device */
        uint8_t _7_display1; /* addr 0x0006, slave DC_Device */
        uint8_t _8_display1; /* addr 0x0007, slave DC_Device */
        uint8_t _9_display1; /* addr 0x0008, slave DC_Device */
        uint8_t _10_display1; /* addr 0x0009, slave DC_Device */
        uint8_t _11_display1; /* addr 0x000A, slave DC_Device */
        uint8_t _12_display1; /* addr 0x000B, slave DC_Device */
        uint8_t _13_display1; /* addr 0x000C, slave DC_Device */
        uint8_t _14_display1; /* addr 0x000D, slave DC_Device */
        uint8_t _15_display1; /* addr 0x000E, slave DC_Device */
        uint8_t _16_display1; /* addr 0x000F, slave DC_Device */
        uint32_t Target_pos1; /* addr 0x0010, slave DC_Device */
        uint32_t Max_speed1; /* addr 0x0014, slave DC_Device */
        uint32_t Relays1; /* addr 0x0018, slave DC_Device */
        uint32_t Control_flags1; /* addr 0x0018, slave DC_Device */
	...
	uint16_t Dbg_fixed1; /* addr 0x001C, slave DC_Device */
        uint16_t Dbg_counter1; /* addr 0x001E, slave DC_Device */
        uint32_t Enc01; /* addr 0x0020, slave DC_Device */
        uint32_t Enc11; /* addr 0x0024, slave DC_Device */
        uint32_t Enc21; /* addr 0x0028, slave DC_Device */
        uint32_t Enc31; /* addr 0x002C, slave DC_Device */
        uint32_t Buttons1; /* addr 0x0030, slave DC_Device */
        uint32_t Flags1; /* addr 0x0034, slave DC_Device */
        uint32_t Enc_abs1; /* addr 0x0038, slave DC_Device */
        uint32_t Enc_quad1; /* addr 0x003C, slave DC_Device */
        uint32_t Limiters1; /* addr 0x0040, slave DC_Device */
        uint32_t Motor_pos1; /* addr 0x0044, slave DC_Device */
        int32_t Motor_speed1; /* addr 0x0048, slave DC_Device */
